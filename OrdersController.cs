...
namespace S2G7_PVFAPP.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.Customer).Include(o => o.OrderLine);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.OrderID = new SelectList(db.OrderLines, "OrderID", "OrderID");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "OrderID,OrderDate,CustomerID")] Order order)
        {
            ...
            ViewBag.OrderID = new SelectList(db.OrderLines, "OrderID", "OrderID", order.OrderID);
            return View(order);
        }
