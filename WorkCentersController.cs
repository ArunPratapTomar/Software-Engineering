...
namespace S2G7_PVFAPP.Controllers
{
    public class WorkCentersController : Controller
    {
        ...
        {
            var workCenters = db.WorkCenters.Include(w => w.ProducedIn);
            return View(workCenters.ToList());
        }
        ...
        {
            ViewBag.WorkCenterID = new SelectList(db.ProducedIns, "WorkCenterID", "WorkCenterID");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "WorkCenterID,WorkCenterLocation")] WorkCenter workCenter)
        {
            ...
            ViewBag.WorkCenterID = new SelectList(db.ProducedIns, "WorkCenterID", "WorkCenterID", workCenter.WorkCenterID);
            return View(workCenter);
        }
